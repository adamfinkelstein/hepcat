...
[Ben Edelman](https://www.benjaminedelman.com/) and
...
Baris Onat and Adam Finkelstein using modern web development tools.

### Customization

The Preferences page lets you choose your own font sizes and color palette. 

In addition, you can choose a set of "favorites" and they will be highlighted in the papers "queue", and can optionally be highlighted in the "grid."
